...
#
# What it does:
#   Adds @te-river/opencode-gov-mode@latest to ~/.config/opencode/opencode.jsonc.
...
$PKG = "@te-river/opencode-gov-mode@latest"

Write-Host ""
Write-Host "OpenCode Gov Mode Installer" -ForegroundColor Cyan
...
'@
        $nodeScriptPath = "$env:TEMP\install-govmode.js"
